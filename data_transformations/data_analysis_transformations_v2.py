...
if __name__ == "__main__":
    ...
    for file in DATA_FILES:
        ...
        if VISIALISE:
            ...
            plt.savefig(
                os.path.join(VISIALISATIONS_DIR, f"{file_name}_corr_matrix.png")
            )

        df.to_csv(os.path.join(DATA_DIR_TR_V2, f"{file_name}.csv"), index=False)
        plt.close()
